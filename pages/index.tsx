    ...
    <div className="min-h-screen bg-gradient-to-b from-[#5a2a00] to-[#c85000] text-white p-10">
      ...
      <main className="text-center">
        ...
        <div className="mt-10 flex justify-center gap-6">
          <button className="px-6 py-3 bg-[#d6541a] text-white rounded font-semibold">EUROPE</button>
          <button className="px-6 py-3 bg-[#d6541a] text-white rounded font-semibold">REST OF THE WORLD</button>
        </div>
      </main>
    </div>
  );
